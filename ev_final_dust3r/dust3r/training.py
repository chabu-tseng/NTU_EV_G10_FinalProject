...
def train(args):
    ...
    # print("\n[Trainable parameters for downstream_head1]:")
    # print(f"downstream_head1.proj.weight: {model.downstream_head1.proj.weight.shape}")
    # print(f"downstream_head1.proj.bias: {model.downstream_head1.proj.bias.shape}")

    # print("\n[Trainable parameters for downstream_head2]:")
    # print(f"downstream_head2.proj.weight: {model.downstream_head2.proj.weight.shape}")
    # print(f"downstream_head2.proj.bias: {model.downstream_head2.proj.bias.shape}")

    # print("\n[Trainable parameters for downstream_head3]:")
    # print(f"downstream_head3.proj.weight: {model.downstream_head3.proj.weight.shape}")
    # print(f"downstream_head3.proj.bias: {model.downstream_head3.proj.bias.shape}")
